...
Parser = function(options) {
  ...
  if ((base4 = this.options).empty_value == null) {
    base4.empty_value = void 0;
  }
  if ((base5 = this.options).columns == null) {
    base5.columns = null;
  }
  if ((base6 = this.options).comment == null) {
    base6.comment = '';
  }
  if ((base7 = this.options).objname == null) {
    base7.objname = false;
  }
  if ((base8 = this.options).trim == null) {
    base8.trim = false;
  }
  if ((base9 = this.options).ltrim == null) {
    base9.ltrim = false;
  }
  if ((base10 = this.options).rtrim == null) {
    base10.rtrim = false;
  }
  if ((base11 = this.options).auto_parse == null) {
    base11.auto_parse = false;
  }
  if ((base12 = this.options).auto_parse_date == null) {
    base12.auto_parse_date = false;
  }
  if ((base13 = this.options).relax == null) {
    base13.relax = false;
  }
  if ((base14 = this.options).relax_column_count == null) {
    base14.relax_column_count = false;
  }
  if ((base15 = this.options).skip_empty_lines == null) {
    base15.skip_empty_lines = false;
  }
  if ((base16 = this.options).max_limit_on_data_read == null) {
    base16.max_limit_on_data_read = 128000;
  }
  this.lines = 0;
  this.count = 0;
  this.is_int = /^(\-|\+)?([1-9]+[0-9]*)$/;
